...
user_input = st.chat_input("Ask a question or wait for a suggestion...")
...
if uploaded_file:
    ...
    if user_input:
        ...
        Also if it is in the form of json, then suggest a possible chart type and x-axis and y-axis in the form of:
        eg: Recommended chart type: bar
            X-axis: Party
            Y-axis: Number of expenses
        If it is not a a list type answer of which dataframe can not be made then only answer the question asked.
        ...
        with st.spinner("Thinking..."):
            try:
                ...
                # Attempt to extract a list of dicts from the response
